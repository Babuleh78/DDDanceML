...
# Ключевые точки медиапайп (из 33):
# 0-4: голова/лицо
# 5-8: правая рука (плечо, локоть, запястье)
# 9-12: левая рука (плечо, локоть, запястье)
# 11-14: правая нога (бедро, колено, лодыжка)
# 15-18: левая нога (бедро, колено, лодыжка)
# 23, 24: бёдра
