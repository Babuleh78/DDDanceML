...
DESCRIPTION_SYSTEM_PROMPT = (
    ...
    "После описания главных характеристик движения, можешь добавить 1-2 коротких предложения с акцентами на конкретные части тела, но только если это действительно заметно. "
