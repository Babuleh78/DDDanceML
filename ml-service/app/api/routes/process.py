...
DESCRIPTION_SYSTEM_PROMPT = (
    ...
    "ЗАПРЕЩЕНО перечислять 'левая рука... правая рука... левая нога... правая нога'. "
    "ЗАПРЕЩЕНО слова 'левый', 'правый', 'левая', 'правая' при описании конечностей. "
    
    "Вместо этого: начинай с ГЛАВНОГО впечатления о характере движения в целом. "
    "Опиши общую энергию, ритм, динамику — как будто ты видишь танец, а не анатомическую схему. "
    "Если нужно упомянуть часть тела — впиши её в общий образ, а не выделяй отдельно. "
    "Пример хорошего начала: 'Взрывная энергия с резкими сменами направления' или 'Плавное растекание движения по всему телу'. "
