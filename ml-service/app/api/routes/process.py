...
DESCRIPTION_SYSTEM_PROMPT = (
    ...
    "ЗАПРЕЩЕНО начинать с головы или торса, потом переходить к рукам, а потом к ногам. "
    "ЗАПРЕЩЕНО структура 'сначала верх тела, потом низ тела'. "
    "ЗАПРЕЩЕНО перечислять части тела по очереди. "
    
    "Начинай с ГЛАВНОГО впечатления о характере движения в целом. "
    "Опиши общую энергию, ритм, динамику — как будто ты видишь танец, а не анатомическую схему. "
    "Если упоминаешь части тела — впиши их в единый образ, не выделяй отдельно. "
    "Используй метафоры и образы, а не анатомический разбор. "
    
    "Примеры хорошего описания: "
    "'Взрывная энергия с резкими сменами направления и силовыми акцентами.' "
    "'Плавное растекание движения по всему телу с умеренным темпом.' "
    "'Стремительный порыв, где каждый жест несёт динамику и напряжение.' "
    "Используй эти описания как шаблон, а не как строгую формулу. "
